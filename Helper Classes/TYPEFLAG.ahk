...
Documentation:
	- *class documentation* (http://maul-esel.github.com/COM-Classes/AHK_Lv1.1/TYPEFLAG)
	- *msdn* (http://msdn.microsoft.com/en-us/library/windows/desktop/ms221509%28v=VS.85%29.aspx)
