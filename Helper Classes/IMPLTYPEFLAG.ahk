...
Documentation:
	- *class documentation* (http://maul-esel.github.com/COM-Classes/AHK_Lv1.1/IMPLTYPEFLAG)
	- *msdn* (http://msdn.microsoft.com/en-us/library/windows/desktop/ms221065%28v=vs.85%29.aspx)
