...
Documentation:
	- *class documentation* (http://maul-esel.github.com/COM-Classes/AHK_Lv1.1/VARKIND)
	- *msdn* (http://msdn.microsoft.com/en-us/library/windows/desktop/ms221381%28v=VS.85%29.aspx)
