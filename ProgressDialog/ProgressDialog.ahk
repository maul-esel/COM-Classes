...
>		MyProgress.SetProgress(50, 100)
	*/
	...
	{
		return this._Error(DllCall(NumGet(this.vt, 08*A_PtrSize, "Ptr"), "Ptr", this.ptr, "UInt", current, "UInt", total, "Int"))
	}
	...
	*/
	...
	{
		return this._Error(DllCall(NumGet(this.vt, 09*A_PtrSize, "Ptr"), "Ptr", this.ptr, "Int64", current, "Int64", total, "Int"))
	}
